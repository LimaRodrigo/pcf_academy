...
export class PositiveConfimation implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    private theComponent: ComponentFramework.ReactControl<IInputs, IOutputs>;
    private notifyOutputChanged: () => void;
    private inputPositiveconfimationok: boolean | undefined;
    private inputisSucess: boolean | undefined;
    /**
     * Empty constructor.
     */
    constructor() { }
    ...
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary): void {
        ...
        this.inputPositiveconfimationok = context.parameters.positiveconfimationok.raw;
    }
    ...
    public getOutputs(): IOutputs {
        return {
            isSucess: this.inputisSucess,
            positiveconfimationok: this.inputPositiveconfimationok
